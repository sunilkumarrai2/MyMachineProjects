...
foreach($data as $item){
    ...
    $category_detail->amount = (int)$item->default_amount;
 
    // create the product
    if(!$category_detail->create()){
        $status = false;
    }
}
...
if($status){
    echo '{';
    echo '"message": "category_detail was created."';
    echo '}';
}
...
// if unable to create the product, tell the user
    ...
    echo '{';
    echo '"message": "Unable to create category_detail."';
    echo '}';
}
?>