 ...
 */
angular.module("Portfolio_Frontend").controller("myCtrl", function($scope, $location, $anchorScroll,Lightbox) {
    $scope.firstName = "John";
    $scope.lastName = "Doe";
    $scope.noOfBeautyPic = 8;
    $scope.beautyItertor = 0;

    $scope.images = [
        {
            'url': 'images/profile_pic.jpeg',
            'thumbUrl': 'http://placehold.it/400x300',
